import { Form, InputNumber, Popconfirm, Table, Typography, Input, Button, Space, message, Switch, Card } from "antd";
import { useEffect, useRef, useState } from "react";
import { getAllUsersList, addNewUser, deleteUser, updateUsers } from "../dataHandles/userService";
...
const AccountManagementTable = ({ originData, onDelete, updateUserData }) => {
    ...
    const save = async (key) => {
        try {
            ...
            updateUsers(updatedUserDetails);
